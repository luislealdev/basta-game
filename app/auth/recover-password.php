...
<body>
    <main class="flex justify-content align-center bg-notebook">
        <div class="flex column gap-15 bg-white p-40" style="min-width: 250px">
            <h1 class="primary-color f-size-24 center-text">Recuperar contraseña</h1>
            <form action="/basta/class/acceso.php" method="POST" class="flex column">
                <input type="hidden" name='action' value='recoverPwd'>
                <input type="text" name="mail" placeholder="Ingresa tu correo" class="input border-primary" />
                ...
                ?>
                <button type="submit" class="p-10 radius no-border mt-20 f-size-14 bg-primary white-text">Recuperar contraseña</button>
            </form>
            <a href="./" class="p-10 radius no-border mt-10 center-text f-size-14 hover-underline">Regresar al inicio</a>
        </div>
    </main>
</body>
